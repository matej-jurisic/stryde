...
namespace Stryde.Core.Migrations
{
    ...
    [Migration("20260730212320_AddUnaccountedTimeRequirements")]
    partial class AddUnaccountedTimeRequirements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stryde.Core.Entities.OccurrenceSubtask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Stryde.Core.Entities.UnaccountedTimeRequirement", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("UserId", "StateValueId");

                    b.HasIndex("StateValueId");

                    b.ToTable("UnaccountedTimeRequirements");
                });
            ...
            modelBuilder.Entity("Stryde.Core.Entities.UnaccountedTimeRequirement", b =>
                {
                    ...
                    b.HasOne("Stryde.Core.Entities.UserSettings", "Settings")
                        .WithMany("UnaccountedRequirements")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Stryde.Core.Entities.UserSettings", b =>
                {
                    b.Navigation("UnaccountedRequirements");
                });
